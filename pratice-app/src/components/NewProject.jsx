...
export default function NewProject({onAdd,onCancel}){
    ...
    <div className="w-[35rem] mt-16">
        <menu className="flex items-center justify-end gap-4 my-4">
            <li className="text-stone-800 hover:text-stone-950"><button onClick={onCancel}>Cancel</button></li>
            <li className="px-6 py-2 rounded-md bg-stone-800 text-stone-50 hover:bg-stone-950"><button
            onClick={handleSave}
            >Save</button></li>
        </menu>
        <div>
