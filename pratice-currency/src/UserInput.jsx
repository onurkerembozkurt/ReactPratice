...
<div className="input-group">
    <p>
        ...
        <input type="number" required value={userInput.initialInvesment} onChange={(event)=>onChange("initialInvestment",event.target.value)}></input>
    </p>
    <p>
        <label>Annual Invesment</label>
        <input type="number" required value={userInput.annualInvesment} onChange={(event)=>onChange("annualInvesment",event.target.value)}></input>
    </p>
